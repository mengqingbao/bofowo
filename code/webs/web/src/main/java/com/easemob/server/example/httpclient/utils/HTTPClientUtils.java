...
import com.common.engine.util.HttpExcuteUtil;
...
public class HTTPClientUtils {
	...
	public static JSONObject sendHTTPRequest(URL url, Credential credentail, Object dataBody, String method) {
		...
		JSONObject resObjectNode = new JSONObject();
		...
		try {
			...
			if (null != entity) {
				...
				if(null!=responseContent){
					JSONObject jsonContent =  JSONObject.fromObject(responseContent);
					resObjectNode.put("Response", jsonContent);
				}
